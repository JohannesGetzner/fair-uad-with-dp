...
$ANACONDA_PYTHON -u train.py --run_config dp --run_version "v1_best" --dataset "rsna-old" --train_dataset_mode "best" --group_name_mod "subsetperformance" --d "${date}" --no_img_log
