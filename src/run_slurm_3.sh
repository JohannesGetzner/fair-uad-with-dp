...
$ANACONDA_PYTHON -u train.py --run_config normal --run_version "distill_baseline"  --no_img_log  --n_training_samples 1 --group_name_mod "bs32-balanced-dataset-distillation-fullmodel-nsamples1"  --d "${date}"