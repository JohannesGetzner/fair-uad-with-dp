...
python train.py --run_config normal --run_version v1 --protected_attr_percent 0.00 --second_stage_epsilon -1 --d "${date}" --group_name_mod "bs32-ss"
python train.py --run_config normal --run_version v1 --protected_attr_percent 0.25 --second_stage_epsilon -1 --d "${date}" --group_name_mod "bs32-ss"
python train.py --run_config normal --run_version v1 --protected_attr_percent 0.50 --second_stage_epsilon -1 --d "${date}" --group_name_mod "bs32-ss"
