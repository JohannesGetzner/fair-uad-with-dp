...
$ANACONDA_PYTHON train.py --run_name dp_1 --protected_attr_percent 0.75 --custom 0.9 --d "${date}"
$ANACONDA_PYTHON train.py --run_name dp_1 --protected_attr_percent 0.75 --custom 0.7 --d "${date}"
$ANACONDA_PYTHON train.py --run_name dp_1 --protected_attr_percent 0.75 --custom 0.5 --d "${date}"
$ANACONDA_PYTHON train.py --run_name dp_1 --protected_attr_percent 0.75 --custom 0.3 --d "${date}"
$ANACONDA_PYTHON train.py --run_name dp_1 --protected_attr_percent 0.75 --custom 0.1 --d "${date}"
