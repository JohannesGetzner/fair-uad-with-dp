...
date=$(date '+%Y-%m-%d %H:%M:%S')
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.55 --d "${date}" --group_name_mod "bs32--upsamplingeven"
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.60 --d "${date}" --group_name_mod "bs32--upsamplingeven"
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.65 --d "${date}" --group_name_mod "bs32--upsamplingeven"
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.70 --d "${date}" --group_name_mod "bs32--upsamplingeven"
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.75 --d "${date}" --group_name_mod "bs32--upsamplingeven"
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.80 --d "${date}" --group_name_mod "bs32--upsamplingeven"
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.85 --d "${date}" --group_name_mod "bs32--upsamplingeven"
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.90 --d "${date}" --group_name_mod "bs32--upsamplingeven"
$ANACONDA_PYTHON -u train.py --run_config normal --run_version v2 --protected_attr_percent 0.95 --d "${date}" --group_name_mod "bs32--upsamplingeven"